  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{POLICY_EVALUATION_LABELS.settingsActivationTitle}</h1>
          <p className="text-gray-600 mt-1">
            Control policy rollout and simulate evaluation decisions — Policy Evaluation consumes
            governance truths; it does not own them.
          </p>
        </div>
