...
import { PdpActivationConsole } from './PdpActivationConsole';
...
describe('PdpActivationConsole UI', () => {
  ...
  it('uses light shell page title and simulation section (no dark PDP panel)', async () => {
    ...
    expect(await screen.findByRole('heading', { name: /Governance Activation/i })).toBeInTheDocument();
    expect(screen.getByText(/Control policy rollout and simulate enforcement decisions/i)).toBeInTheDocument();
